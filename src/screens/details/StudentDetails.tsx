                          ...
                          {isEditing ? (
                            <div className="space-y-3">
                              ...
                              <div className="flex justify-end">
                                <Button size="sm" onClick={() => studentId && handleSaveAttendance(entry.recordId, studentId)}>
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <Button
                                  size="sm"
                                  variant="ghost"
                                  onClick={() => studentId && handleEditAttendance(entry.recordId, studentId, entry.status, entry.notes || '')}
                                >
                      ...
                      <div key={result.id} className="p-3 border rounded-lg">
                        {isEditing ? (
                          <div className="space-y-3">
                            {/* Title and cancel button on same row */}
                            <div className="flex items-center justify-between">
                              <p className="font-medium">{(result as any).test?.title}</p>
                            ...
                            <div className="flex items-center gap-4 text-sm text-muted-foreground">
                              <span>Date: {new Date((result as any).submissionDate || result.createdDate).toLocaleDateString()}</span>
                              <div className="flex items-center gap-2 ml-auto">
                                <Input
                                  type="number"
                                  placeholder="Score"
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex-1">
                              ...
                              <p className="text-sm text-muted-foreground">
                                {new Date((result as any).submissionDate || result.createdDate).toLocaleDateString()}
                              </p>
                              {result.feedback && (
